...
class LoginView(
    ...
    def form_valid(self, form):
        ...
        create_log_activity(user_obj,"Signin successfully")
...
class SignupView(
    ...
    def form_valid(self, form):
        ...
        create_log_activity(self.user,"Signup successfully")
...
class ConfirmEmailView(TemplateResponseMixin, LogoutFunctionalityMixin, View):
    ...
    def post(self, *args, **kwargs):
        ...
        create_log_activity(user_obj,"Email is verify successfully")
...
class PasswordChangeView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    def form_valid(self, form):
        form.save()
        update_log_activity(self.request.user,"Password changed successfully")
...
class PasswordResetView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        email = form.cleaned_data['email']
        user_obj = User.objects.get(email=email)
        create_log_activity(user_obj,"Password-reset link send successfully")
...
class PasswordResetFromKeyView(
    ...
    def form_valid(self, form):
        form.save()
        create_log_activity(form.user,"password-reset successfully")
        adapter = get_adapter(self.request)
...
class LogoutView(TemplateResponseMixin, LogoutFunctionalityMixin, View):
    ...
    def post(self, *args, **kwargs):
        ...
        if self.request.user.is_authenticated:
            create_log_activity(self.request.user, "Signout account successfully")
            self.logout()
